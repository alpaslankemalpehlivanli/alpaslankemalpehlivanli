...
this.data();var b=this.turn("range");for(a=b[0];a<=b[1];a++)g._addPage.call(this,a)},range:function(a){var b=this.data(),a=a||b.tpage||b.page;if(1>a||a>b.totalPages)throw Error('"'+a+'" is not a page for range');return[1,b.totalPages]},_necessPage:function(a){if(0===a)return!0;
